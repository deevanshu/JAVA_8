...
public class OptionalDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //System.out.println(emailOptional);    //  gives null pntr exception

        Optional<String> emailOptional2 = Optional.ofNullable(customer.getEmail());  // empty + of  combination  , here o/p as optional.empty
